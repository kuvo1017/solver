...
void GVInitializer::init(const string& dataPath)
{
  ...
  GVManager::setNewString("RESULT_NODE_INFO_FILE",
      resultPath + "node_info.txt");
  GVManager::setNewString("RESULT_LINK_INFO_FILE",
      resultPath + "link_info.txt");
  GVManager::setNewString("RESULT_ROAD_ENTITY_INFO_FILE",
      resultPath + "road_entity_info.txt");

  GVManager::setNewString("RESULT_GLOBAL_STATIC_FILE",
      resultPath + "global_static.txt");
  GVManager::setNewString("RESULT_GLOBAL_DYNAMIC_FILE",
      resultPath + "global_dynamic.txt");

  GVManager::setNewString("RESULT_VEHICLE_STATIC_FILE",
      resultPath + "vehicle_static.txt");
  GVManager::setNewString("RESULT_VEHICLE_DISTANCE_FILE",
      resultPath + "vehicle_distance.txt");
